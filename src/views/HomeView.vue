...
<template>
  <div class="bg-primary-50">
    ...
    <div class="flex flex-col justify-center items-center my-7 max-w-lg mx-auto lg:rounded-md">
      ...
      <select 
        ...
        class=" my-2 mx-5 px-4 py-2 text-center border bg-primary-400 border-primary-800 text-gray-100 text-sm rounded-lg font-bold focus:ring-gray-500 focus:border-gray-500 block w-3/4">
